...
namespace Fellesregnskap.Tests.App_Code
{
    ...
    public class MongoAccesorTest
    {
        ...
        {
            var receipts1 = MongoAccessor.GetReceiptsByMonth(14);
            Assert.AreEqual(2, receipts1.Count);
            var receipts2 = MongoAccessor.GetReceiptsByMonth(DateTime.Now.Month);
        ...
        public void TestGetAllReceiptsForParticipantByMonth()
        {
            ...
            var receipts1 = MongoAccessor.GetAllReceiptsForParticipantByMonth(participant1, 14);
            Assert.AreEqual(1, receipts1.Count);
            var participant2 = MongoAccessor.GetParticipant("Annie");
            var receipts2 = MongoAccessor.GetAllReceiptsForParticipantByMonth(participant2, DateTime.Now.Month);
            Assert.AreEqual(0, receipts2.Count);
            var participant3 = MongoAccessor.GetParticipant("Abed");
            var receipts3 = MongoAccessor.GetAllReceiptsForParticipantByMonth(participant3, DateTime.Now.Month);
        ...
        public void TestGetAllReceiptsForPayerByMonth()
        {
            ...
            var receipts1 = MongoAccessor.GetAllReceiptsForPayerByMonth(payer1, 14);
            Assert.AreEqual(1, receipts1.Count);
            var receipts2 = MongoAccessor.GetAllReceiptsForPayerByMonth(payer1, DateTime.Now.Month);
            Assert.AreEqual(2, receipts2.Count);
            var receipts3 = MongoAccessor.GetAllReceiptsForPayerByMonth(payer1, 15);
